    ...
    <div className="min-h-screen">
      ...
      <header className="border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3 text-sm">
            <Link
              href="/login"
              className="rounded-md px-3 py-1.5 text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100"
            >
              Log in
            </Link>
            <Link
              href="/signup"
              className="rounded-md bg-slate-900 px-4 py-1.5 font-medium text-white hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-white"
            >
              Get started
            </Link>
          </div>
      ...
      <main className="mx-auto max-w-5xl px-6">
        <section className="py-16 text-center sm:py-24">
          ...
          <h1 className="mx-auto mt-5 max-w-3xl text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl dark:text-slate-100">
            Stop sharing <code className="rounded bg-slate-100 dark:bg-slate-800 px-2">.env</code>{" "}
            files over Slack
          </h1>
          ...
          <div className="mt-8 flex justify-center gap-3">
            <Link
              href="/signup"
              className="rounded-md bg-slate-900 px-6 py-3 text-sm font-medium text-white hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-white"
            >
              Create your account
            </Link>
            <Link
              href="/login"
              className="rounded-md border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 px-6 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
            >
              Log in
            </Link>
          </div>
        ...
        {/* The problem */}
        <section className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 sm:p-10">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-3">
            {FEATURES.map((f) => (
              ...
              >
                ...
                <h3 className="mt-3 font-medium text-slate-900 dark:text-slate-100">{f.title}</h3>
        ...
        <section className="pb-16">
          ...
          <ol className="mx-auto mt-8 grid max-w-3xl gap-4">
            {STEPS.map((s, i) => (
              <li
                key={i}
                className="flex gap-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5"
              >
                <span className="flex h-8 w-8 flex-none items-center justify-center rounded-full bg-slate-900 text-sm font-semibold text-white dark:bg-slate-100 dark:text-slate-900">
                  {i + 1}
                </span>
